...
Nomdefichierenchiffreuniquement = 0
extensiondesauvegarde =".jpg"
boucle = int(0)
...
while boucle<1 : 
    ...
    if blobs_log.size:
        plt.savefig("DéfautN°{0}{1}".format(Nomdefichierenchiffreuniquement,extensiondesauvegarde))
        Nomdefichierenchiffreuniquement = Nomdefichierenchiffreuniquement+1
       
    plt.show()   
    boucle = int(input("presse 1 pour arreter et presse 0 pour relancer = "))
